...
pub unsafe fn enif_select_read(
    env: *mut ErlNifEnv,
    event: ErlNifEvent,
    obj: *mut c_void,
    pid: *const ErlNifPid,
    ...
    enif_select_x(
        env,
        event,
        ERL_NIF_SELECT_READ | ERL_NIF_SELECT_CUSTOM_MSG,
        obj,
        pid,
        msg,
        msg_env,
...
pub unsafe fn enif_select_write(
    env: *mut ErlNifEnv,
    event: ErlNifEvent,
    obj: *mut c_void,
    pid: *const ErlNifPid,
    ...
    enif_select_x(
        env,
        event,
        ERL_NIF_SELECT_WRITE | ERL_NIF_SELECT_CUSTOM_MSG,
        obj,
        pid,
        msg,
        msg_env,
...
pub unsafe fn enif_select_error(
    env: *mut ErlNifEnv,
    event: ErlNifEvent,
    obj: *mut c_void,
    pid: *const ErlNifPid,
    ...
    enif_select_x(
        env,
        event,
        ERL_NIF_SELECT_ERROR | ERL_NIF_SELECT_CUSTOM_MSG,
        obj,
        pid,
        msg,
        msg_env,
